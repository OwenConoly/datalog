...
datalog: util
	$(MAKE) -f Makefile.coq src/datalog/Datalog.vo src/datalog/Blocks.vo src/datalog/Interpreter.vo src/datalog/AggregatingProgram.vo src/datalog/Operational.vo src/datalog/Local.vo src/datalog/Graph.vo
