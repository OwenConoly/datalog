...
datalog: util
	$(MAKE) -f Makefile.coq src/datalog/Datalog.vo src/datalog/RelMap.vo src/datalog/Blocks.vo src/datalog/Interpreter.vo src/datalog/AggregatingProgram.vo src/datalog/Node.vo src/datalog/Operational.vo src/datalog/Nattify.vo src/datalog/Local.vo src/util/Graph.vo src/datalog/Distributed.vo src/datalog/OperationalWithIO.vo src/datalog/OperationalToDistributed.vo
